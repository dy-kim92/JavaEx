...
//		stringTest();
	...
	private static void stringFormatEx() {
		...
		System.out.printf(fmt, 5, "오렌지", 2);		// 내용 변경
		
		//	%f (실수), %% (%)
		// 현재 이자율은 1.25% 입니다.
		System.out.printf("현재 이자율은 %f입니다.\n", 1.25f);
		fmt = "현재 이자율은 %.2f%%입니다.\n";	// %.2f -> 소수점 2째자리까지 표기
	...
	private static void stringTest() {
		...
		System.out.println("str과 str3의 내용이 같은가? " + str.equals(str3));	// 다른 객체이지만 값은 서로 같음
