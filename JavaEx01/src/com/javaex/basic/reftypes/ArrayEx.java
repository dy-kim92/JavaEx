...
//		arrayCopyFor();
	...
	private static void arrayCopySystem() {
		...
		System.arraycopy(source, 0, target, 0, source.length);	// ( 원본배열, 복사시작위치, 타겟배열, 타겟배열의 시작위치, 길이 )
...
///////////////////////////////////////////////////////////////////////////	
	private static void arrayCopyFor() {
		// 배열복사
		// 배열은 크기 변경이 불가, 추가 공간을 확보하려면 새 배열을 만들고 원래 요소값을 복사해야 함
		int source[] = {1, 2, 3};
		int target[] = new int[10];
...
///////////////////////////////////////////////////////////////////////////	
	private static void twoDimens() {
		...
		System.out.println("배열 요소의 총합 : " + total);
